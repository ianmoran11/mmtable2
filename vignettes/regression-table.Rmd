---
title: "Regression table (multiple merged column headers)"
output: 
  rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Regression table (multiple merged column headers)}
...
The modeling and data preparation are not our primary concern here, but click "Expand" below if you'd like to see the function completes these tasks.  
