...
gm_table %>% mmtable2::apply_formats()
```
...
```{r, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "600px"}
ex2 <- t1 / t4
ex2 %>% mmtable2::apply_formats()
```

The `*` operator "integrates" tables  
```{r, message=FALSE, warning=FALSE, paged.print=FALSE, out.width = "600px"}
ex3 <- t1 * t5 * t4 *  t2
ex3 %>% mmtable2::apply_formats()
```
...
gm_table_formatted %>% mmtable2::apply_formats()
```
...
gm_table_merged %>% mmtable2::apply_formats()
```
...
gm_table_piped %>% mmtable2::apply_formats()
```
