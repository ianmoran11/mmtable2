...
col_list <- cells_body(columns = c(3,5,7,9,11))
style_list <- list(cell_borders(sides = "top",color = "darkgrey",weight = px(2)))
style_list2<- list(cell_borders(sides = "left"))
gm_df <- gapminder_mm %>% filter(var != "Life expectancy")
style_list3 = list(cell_text(align = "left"))
...
webshot(url = apply_formats(gm_table_piped),file = "test01.png")
